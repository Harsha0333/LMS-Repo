...
public class Log4jProperties {
	...
	public static void propertFileCreater() throws IOException{
		...
		FileOutputStream fis = new FileOutputStream(Constants.LOG4JPROP);
		...
		props.setProperty("log4j.appender.file.File", "target/Logs/CRMLoags$"+Constants.getDateTimeString()+".log");
